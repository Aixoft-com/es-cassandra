...
public class Aggregate<T> extends AggregateRoot<T> {
     ...
     * <p>
     * If validation returns 'false' (See {@link Command#validate(Aggregate)}), then event is skipped from processing.
     * If validation throws exception then processing is interrupted and no event will be applied for aggregate.
     *
